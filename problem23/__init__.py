...
if __name__ == '__main__':
    ...
    abundant_numbers = [i for i in num_range if d(i) > i]
    abundant_sums = set(sum(c) for c in combinations_with_replacement(abundant_numbers, 2))
    print((sum(i for i in num_range if i not in abundant_sums)))
